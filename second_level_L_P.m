% Second level for logical and pragmatic responders separately
...
for curr_group = 1:length(groups)
    ...
    curr_dir_path = fullfile(curr_second_level_dir, curr_dir_name);
    ...
    inputs{2, crun} = curr_contrasts(curr_idx)'; % Factorial design specification: Scans - cfg_files
