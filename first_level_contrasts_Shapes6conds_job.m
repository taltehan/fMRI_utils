...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'Basic_AllvsNull';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [1 1 1 1 1 1];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'repl';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'HelekSome-KolAll';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.weights = [0 -1 1 0 0 0];
matlabbatch{3}.spm.stats.con.consess{2}.tcon.sessrep = 'repl';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'HelekAll-KolAll';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.weights = [1 -1 0 0 0 0];
matlabbatch{3}.spm.stats.con.consess{3}.tcon.sessrep = 'repl';
matlabbatch{3}.spm.stats.con.consess{4}.tcon.name = 'HelekAll-HelekSome';
matlabbatch{3}.spm.stats.con.consess{4}.tcon.weights = [1 0 -1 0 0 0];
matlabbatch{3}.spm.stats.con.consess{4}.tcon.sessrep = 'repl';
matlabbatch{3}.spm.stats.con.consess{5}.tcon.name = 'HelekAll-HelekNone';
matlabbatch{3}.spm.stats.con.consess{5}.tcon.weights = [1 0 0 -1 0 0];
matlabbatch{3}.spm.stats.con.consess{5}.tcon.sessrep = 'repl';
matlabbatch{3}.spm.stats.con.consess{6}.tcon.name = 'HelekNone-KolNone';
